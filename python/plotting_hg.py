...
def plot_lifetime_frequencies_by_class(df_100, df_50, df_1, df_01, title, with_class_labels):
    ncols = 4
    top_allocated_classes = ['HG2dPoint', 'Rectangle', 'Array']
    fig, axs = plt.subplots(len(top_allocated_classes), ncols, figsize=(9, 9))
    ...
    # First class
    plot_for_top_allocated_class(df_100, top_allocated_classes[0], axs[0, 0], bins=6)
    plot_for_top_allocated_class(df_50, top_allocated_classes[0], axs[0, 1], bins=6)
    plot_for_top_allocated_class(df_1, top_allocated_classes[0], axs[0, 2], bins=5)
    ...
    # Second class
    plot_for_top_allocated_class(df_100, top_allocated_classes[1], axs[1, 0], bins=5)
    plot_for_top_allocated_class(df_50, top_allocated_classes[1], axs[1, 1], bins=4)
    plot_for_top_allocated_class(df_1, top_allocated_classes[1], axs[1, 2], bins=1)
    ...
    # Third class
    plot_for_top_allocated_class(df_100, top_allocated_classes[2], axs[2, 0], bins=5)
    plot_for_top_allocated_class(df_50, top_allocated_classes[2], axs[2, 1], bins=5)
    plot_for_top_allocated_class(df_1, top_allocated_classes[2], axs[2, 2], bins=5)
...
def plot_lifetime_frequencies_by_class_actionable(df_100, df_50, df_1, df_01, title, with_class_labels):
    ncols = 4
    top_allocated_classes = ['HG2dPoint', 'Rectangle', 'Array', 'Form']
    fig, axs = plt.subplots(len(top_allocated_classes), ncols, figsize=(9, 9))
    fig.suptitle(title, fontsize=16)
    axs[0, 0].set_title("Sampling 100%")
    axs[0, 1].set_title("Sampling 50%")
